...
- [x] **T0-13** Unblock CI/CD deploy round 5 — `lifecycle ignore_changes = [billing_account]` (placeholder dans tfvars créait drift) + `cloudbilling.googleapis.com` API. Cascade des 5 root causes complètement documentée → **livré v1.0.8 (PR #39)**
